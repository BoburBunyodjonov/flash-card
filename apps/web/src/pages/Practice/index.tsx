...
import { Brain, Swords, Target, NotebookPen, ChevronRight, type LucideIcon } from 'lucide-react'
...
export function PracticePage({ onQuiz, onDuel, onChallenge, onMyWords }: Props) {
